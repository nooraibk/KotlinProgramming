...
/**considering the single expression function, you can also write the telusko.codinginflow.functions.telusko.datastructures.functions.telusko.dsl.dsl.dsl.dsl.dsl.main function that only has one statement, as follows.

fun telusko.codinginflow.functions.telusko.datastructures.functions.telusko.dsl.dsl.dsl.dsl.dsl.main() = println("hello world")*/
